...
@Configuration
@ComponentScan(basePackages = {"com.jpa.auto"} )
@EnableJpaRepositories(basePackages = {"com.jpa.auto.repository"}, entityManagerFactoryRef = "localContainerEMFBean")
...
public class AutoJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEMFBean(DataSource dataSource, JpaVendorAdapter jpaAdaptor) {
        ...
        localEMF.setPackagesToScan("com.jpa.auto.domain");
